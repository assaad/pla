package lu.snt.serval.pla.sensor.time;
        ...
        try {
            ...
            else
            {
                if((signal.getDateTime().getTime()-ls.get(0).getDateTime().getTime())>timewindow)
                {
                    ...
                    DoubleValueAnswer res = BlurringComp.factory.createDoubleValueAnswer();
                    double sum=0;
                    ...
                    TimeAveraging ta = BlurringComp.factory.createTimeAveraging();
