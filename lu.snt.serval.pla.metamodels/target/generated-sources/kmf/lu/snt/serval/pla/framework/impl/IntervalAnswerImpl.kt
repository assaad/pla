 ...
 */
class IntervalAnswerImpl : lu.snt.serval.kmf.container.KMFContainerImpl, lu.snt.serval.pla.framework.IntervalAnswer { 
...
public override var min : Double? = null
	 set(iP : Double?){
if(isReadOnly()){throw Exception(lu.snt.serval.kmf.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != min){
$min = iP
...
public override var max : Double? = null
	 set(iP : Double?){
if(isReadOnly()){throw Exception(lu.snt.serval.kmf.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != max){
$max = iP
...
lu.snt.serval.kmf.util.Constants.Att_min -> {
this.min = (value.toString().toDouble())
}
lu.snt.serval.kmf.util.Constants.Att_max -> {
this.max = (value.toString().toDouble())
}
...
override fun visitAttributes(visitor : org.kevoree.modeling.api.util.ModelAttributeVisitor){
            visitor.visit(min,lu.snt.serval.kmf.util.Constants.Att_min,this)
            visitor.visit(max,lu.snt.serval.kmf.util.Constants.Att_max,this)
...
return lu.snt.serval.kmf.util.Constants.lu_snt_serval_pla_framework_IntervalAnswer;
}
}
